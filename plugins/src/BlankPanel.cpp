...
BlankPanelSmallWidget::BlankPanelSmallWidget(BlankPanel *module) : ModuleWidget(module) {
    ...
    panel->setBackground(SVG::load(assetGlobal("res/BlankPanelSmall.svg")));//assetPlugin(plugin, "res/BlankPanelSmall.svg")));
	addChild(panel);
...
BlankPanelMediumWidget::BlankPanelMediumWidget(BlankPanel *module) : ModuleWidget(module) {
	...
	SVGPanel *panel = new SVGPanel();
	panel->box.size = box.size;
    panel->setBackground(SVG::load(assetGlobal("res/BlankPanelMedium.svg")));//assetPlugin(plugin, "res/BlankPanelMedium.svg")));
	addChild(panel);
...
BlankPanelLargeWidget::BlankPanelLargeWidget(BlankPanel *module) : ModuleWidget(module) {
	...
	SVGPanel *panel = new SVGPanel();
	panel->box.size = box.size;
    panel->setBackground(SVG::load(assetGlobal("res/BlankPanelLarge.svg")));//assetPlugin(plugin, "res/BlankPanelLarge.svg")));
	addChild(panel);
